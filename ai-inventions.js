...
const kitchenInventions = [
    "Magnetic Utensil Holder for Stove: A magnetic strip that attaches to the stove or range hood, providing a convenient spot to hang cooking utensils.<a href="https://buy.stripe.com/14kbKmgSt3c2cjCcMM" target="_blank">
  <button>Click to Pay</button></a>",
