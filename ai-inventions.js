var stage = 0; 
 ...
 const kitchenInventions = [ 
     { name: "Herb Stripper: This tool looks like a mini comb with small sharp edges. It allows you to easily strip the leaves from herbs without the hassle of doing it by hand.",
     link: "https://buy.stripe.com/28obKm31DbIyabu290"},
     { name: "Avocado Slicer: This gadget has a blade for cutting through avocado's skin, a pit remover to create perfectly even avocado slices.",
     link: "https://buy.stripe.com/28o8ya6dP4g697q9Bt"},
     { name: "Citrus Sprayer: Shaped like a small pump, this invention allows you to spray citrus juice directly from the fruit.",
     link: "https://buy.stripe.com/aEU4hU9q1dQG97q9Bu"},
     { name: "Egg Cuber: This device turns boiled eggs into perfect cubes. It's great for making unique presentations or fun bite sized snacks.",
     link: "https://buy.stripe.com/cN2aGi7hTcMC3N63d7"},
     {name: "Butter Spreader Knife: This knife has small perforations along the blade. It allows you to easily spread cold butter on bread without tearing it.",
     link: "https://buy.stripe.com/4gw4hUgSt5kaabu00W"},
     {name: "Rotary Cheese Grater: This grater has a handle that you turn to grate cheese. It's faster and more convenient than traditional box graters.",
     link: "https://buy.stripe.com/9AQ3dQ1Xz5kacjCdRS"},
     {name: Spoon Rest with Drip Catcher: This spoon has a built in drip catcher to collect any drips from your stirring spoon, keeping your counter clean.",
     link: "https://buy.stripe.com/8wM29M7hTfYO2J24hj"},
     ...
     {name: "Corn Stripper: This tool resembles a peeler with jagged edges. It effortlessly removes kernels from the cob, saving you time and reducing mess.",
     link: "https://buy.stripe.com/7sIg0CdGheUKerK4he"},
     {name: "Silicone Food Huggers: These are silicone covers designed to fit over cut fruits and vegetables. They help keep them freshfor longer and preventfood waste.",
     link: "https://buy.stripe.com/28o4hUgStfYO6ZieVT"},
     {name: "Onion Holder: This gadget looks like a small fork with prongs. It holds the onion securely in place while you slice, preventing slips and cuts.",
     link: "https://buy.stripe.com/fZeeWyeKlbIy5Ve8xw"},
     {name: "Non Stick Pancake Pen: Resembling a large syringe, this tool allows you to dispense pancake batter in precise shapes or designs.",
 ...
 const beautyInventions = [ 
     ...
     link: "https://buy.stripe.com/3csaGi59L5kagzSeV2"}, 
 ...
 const outdoorGearInventions = [ 
    ...
    { name: "Ultra Portable Light Weight Hammock Tent:  that can be easily converted into a tent, providing a versatile and comfortable sleeping arrangement that can be suspended between trees, rocks, or other supports.", 
    link: "https://buy.stripe.com/bIY5lYby98wmgzS7tM"}, 
    ...
    { name: "Emergency Floating Shelter Pod: A compact, buoyant pod that expands into a secure, weather-resistant shelter, providing protection in emergencies or unexpected outdoor situations.", 
    link: "https://buy.stripe.com/3cs3dQ59L13U2J2g0e"}, 
 ...
 const bathroom = [ 
     { name: "Hand Dryer with Built in Timer : This hand dryer activates when it senses motion.", 
     ...
     { name: "Bathtub Wineglass Holder: This quirky inventionis a suction cup based holder that allows you to securely attach your wine glass to the edge of the bathtub.", 
     ...
     { name: "Odor Eliminating Toilet Seat: This toilet seat is designed with a built in carbon filter that absorbs and neutralizes unpleasant odors.", 
